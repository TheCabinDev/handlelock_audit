...
folder_path = "./data_gandekan"

csv_files = [
    f for f in os.listdir(folder_path)
    if f.lower().endswith('.csv')
    and 'gandekan' in f.lower()
...
per_file_writer = pd.ExcelWriter("akses_cleaned_pegandekancabin.xlsx", engine="xlsxwriter")
...
for sumber_file, df_per_file in df_with_source.groupby("sumber_file"):
    ...
    sheet_name = sumber_file.replace(".csv", "").replace("Gandekan_20250619_", "Kamar_")[:31]
...
print("📁 File 'akses_cleaned_pegandekancabin.xlsx' berhasil dibuat!")
