...
df = pd.read_csv('Gandekan_20250619_105.xlsx - Sheet1.csv', skiprows=1)
...
df_cleaned.to_csv('akses_cleaned105.csv', index=False)
df_cleaned.to_excel('akses_cleaned105.xlsx', index=False)
...
plt.tight_layout()
plt.savefig('akses_per_tanggal105.png')
plt.show()
...
plt.ylabel("Jam")
plt.tight_layout()
plt.savefig('heatmap_jam_vs_tanggal105.png')
plt.show()
...
plt.ylabel('')
plt.tight_layout()
plt.savefig('distribusi_card_type105.png')
plt.show()
