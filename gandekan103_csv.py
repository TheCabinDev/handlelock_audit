...
df = pd.read_csv('Gandekan_20250619_103.xlsx - Sheet1.csv', skiprows=1)
...
df_cleaned.to_csv('akses_cleaned103.csv', index=False)
df_cleaned.to_excel('akses_cleaned103.xlsx', index=False)
